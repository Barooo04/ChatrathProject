    ...
    return (
        ...
        <div className="dashboard-container">
            ...
            <div className="legend-mobile">
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('onboarding')} style={{ cursor: 'pointer' }}>
                ...
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('product-market-fit')} style={{ cursor: 'pointer' }}>
                ...
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('growth-engine')} style={{ cursor: 'pointer' }}>
                ...
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('scale-intention')} style={{ cursor: 'pointer' }}>
                ...
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('lead-self')} style={{ cursor: 'pointer' }}>
                ...
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('lead-others')} style={{ cursor: 'pointer' }}>
                ...
                <div className="legend-mobile-item" onClick={() => scrollToAssistantType('lead-organization')} style={{ cursor: 'pointer' }}>
